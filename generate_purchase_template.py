...
fields = [
    ...
    ('K', '满足率(%)', '85.0', '✅', '直接填写百分比数值，如 85、100、75.5、0'),
...
headers = ['采购单号', '品牌', '产品类别', '供应商', '采购数量', 
           '单价(CNY)', '总金额(CNY)', '下单日期', '预计到货', '实际到货', '满足率(%)', '采购状态']
...
# ===== 示例数据（满足率直接填百分比数字） =====
sample_data = [
    ['PO-202506-0001', 'CHANEL', '香水EDP', '法国香奈儿集团', 500, 320, 160000, '2025-06-01', '2025-06-15', '2025-06-14', 100.0, '已到货'],
    ['PO-202506-0002', 'DIOR', '香水EDT', 'LVMH集团', 300, 280, 84000, '2025-06-03', '2025-06-18', '', 0.0, '运输中'],
    ['PO-202506-0003', 'HERMES', '古龙水', '爱马仕国际', 200, 450, 90000, '2025-06-05', '2025-06-20', '', 80.0, '待发货'],
    ['PO-202506-0004', 'JO MALONE', '礼盒套装', '雅诗兰黛集团', 400, 380, 152000, '2025-06-08', '2025-06-22', '', 100.0, '待审核'],
]
...
tips = [
    ...
    '• 实际到货列：未到货则留空',
    '• 满足率(%)列：直接填写百分比数字，如 100、85、75.5、0',
]
...
print(f"   Sheet 1: 使用说明（满足率改为百分比）")
print(f"   Sheet 2: 采购数据（满足率列直接填数字）")
