...
NAV = {
    "🏪 Sell Out 销售端": [
        ...
        {"path": "pages/sell_out/14_品牌表现分析.py",         "title": "品牌表现分析（加密）", "icon": "🔒"},
    ],
    "📦 Sell In 采购端": [
        ...
        {"path": "pages/sell_in/15_sell_in_深度分析.py",      "title": "SELL IN 深度分析（加密）", "icon": "🔒"},
        {"path": "pages/sell_in/16_采购深度分析.py",          "title": "采购深度分析（加密）", "icon": "🔒"},
    ],
    "🚚 物流模块": [
